...
class StoryWidget : AppWidgetProvider() {
    companion object {
        private const val TOAST_ACTION = "com.adisastrawan.storyapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.adisastrawan.storyapp.EXTRA_ITEM"
        ...
        private fun updateAppWidget(
            ...
            val toastPendingIntent = PendingIntent.getBroadcast(
                context, 0, toastIntent, if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S)
